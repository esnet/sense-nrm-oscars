...
class nrmModel(object):
    ...
    def getAvailOK(self):
        ...
        tdiff = t21 - self.last_time
        if (nrm_config["debug"]>2): 
            print "MODEL: Since last time: ", self.last_time
            print "MODEL: Avail in: ", tdiff.total_seconds()
    ...
    def setLastTime(self):
        self.last_time = self.get_delayed_time(0)
        if (nrm_config["debug"]>2):
            print "MODEL: Set last time: ", self.last_time
        ...
        with mydb_session() as s:
            ...
            for mObj in mObjs:
                ...
                if len(mDelta.altvlan) > 0:
                    mydeltavlan = mDelta.altvlan
                    mydeltavlanEmpty = False
                mydeltaurs = mDelta.urs
